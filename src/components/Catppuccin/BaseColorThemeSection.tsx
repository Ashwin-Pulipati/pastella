// components/Catppuccin/CatppuccinThemeSection.tsx
"use client";

import { cn } from "@/lib/utils";
import React from "react";
import { useInView } from "react-intersection-observer";
import CatppuccinColorGrid from "./BaseColorGrid";
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center space-x-4 mb-6 sm:mb-8">
        ...
        <h2
          className={cn(
            "text-center font-sans text-2xl md:text-3xl font-bold uppercase tracking-widest text-muted-foreground"
          )}
        >
          {themeName}
        </h2>
      ...
      <CatppuccinColorGrid themeName={themeName} colorsObject={colorsObject} />
    </div>
  );
};

export default CatppuccinThemeSection;
