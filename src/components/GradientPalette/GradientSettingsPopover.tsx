...
const GradientSettingsPopover = memo(function GradientSettingsPopover({
  settings,
  setSettings,
  isOpen,
  setIsOpen,
  ...
  const handleSettingChange = useCallback(
    <K extends keyof GradientSettings>(key: K, value: GradientSettings[K]) => {
  ...
  const animationTimings: AnimationTiming[] = [
    "linear",
    "ease",
    "ease-in",
    "ease-out",
  ...
  return (
    <div className="relative" ref={popoverRef}>
      ...
      {isOpen && (
        <div className="absolute top-full right-0 mt-2 w-[90vw] max-w-xs rounded-xl bg-card shadow-lg border border-border z-50 p-4">
                    ...
                    <Dropdown
                      ...
                      items={[
                        ...
                        },
                        {
                          id: "circle",
                          label: "Circle",
                          onClick: () => handleSettingChange("shape", "circle"),
                        },
                      ]}
                    />
                  </div>
